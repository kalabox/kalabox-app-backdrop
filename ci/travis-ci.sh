...
COMMAND=$1
EXIT_VALUE=0
PLUGIN_REPO="kalabox/kalabox-app-backdrop"
...
before-install() {
  ...
  if [ $TRAVIS_PULL_REQUEST == "false" ] &&
    ...
    openssl aes-256-cbc -K $encrypted_50aeb71dc291_key -iv $encrypted_50aeb71dc291_iv -in ci/travis.id_rsa.enc -out $HOME/.ssh/travis.id_rsa -d
  fi
}
